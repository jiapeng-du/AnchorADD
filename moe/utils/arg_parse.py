...
#    mes=""
#    # random seed
#    parser.add_argument('--seed', type=int, default=888, help='random seed (default: 1234)')
#    # for DDP
...
#    parser.add_argument('--module_model', type=str, default="models.w2v2_moe_fz24_aasist")
#    # module of torch lightning model train step file
#    parser.add_argument('--tl_model', type=str, default="models.tl_model_moe")
...
#    # checkpoint dir
#    parser.add_argument('--savedir', type=str, default="./a_l/noft_24/2_4_128/", help='save model to this direcotry (default ./)')
# 
#    #######
#    # ⭐options to load model
#    # 'a trained model for inference or resume training '
#    parser.add_argument('--trained_model', type=str, default="./a_l/noft_24/2_4_128/version_1", help=mes + "(default: '')")
#    # infer dataset
...
#    # # learning rate 
#    parser.add_argument('--optim_lr', type=float, default=0.00001,help='learning rate (default: 0.0001)')
...
#    parser.add_argument('--scheduler', type=str, default="cosWarmup")
...
#    parser.add_argument('--usingDA', action='store_true', default=True)
...
def f_args_parsed(argument_input = None):
    ...
    # 'module of model definition (default model, model.py will be loaded)'
#    parser.add_argument('--module_model', type=str, default="models.w2v2_moe_fz24_aasist")
    parser.add_argument('--module_model', type=str, default="models.wave2vec")
    # module of torch lightning model train step file
    parser.add_argument('--tl_model', type=str, default="models.tl_model2")
#    parser.add_argument('--tl_model', type=str, default="models.tl_mlp")
    # datamodule python file
    parser.add_argument('--data_module', type=str, default="utils.loadData.asvspoof_data_DA2")
    ...
    parser.add_argument('--delta_uq', action='store_true', default=True, 
                        help='Enable Delta-UQ uncertainty estimation')
#    parser.add_argument('--delta_uq_anchors', type=int, default=20,
#                        help='Number of anchors for Delta-UQ')
#    parser.add_argument('--delta_uq_hidden', type=int, default=512,
#                        help='Hidden dimension for Delta-UQ encoder')
#    parser.add_argument('--uncertainty_weight', type=float, default=0.1,
#                        help='Weight for uncertainty regularization in loss')
    
    ######
    # ⭐options to save model 
    # checkpoint dir
    parser.add_argument('--savedir', type=str, default="./2", help='save model to this direcotry (default ./)')
 
    #######
    # ⭐options to load model
    # 'a trained model for inference or resume training '
    parser.add_argument('--trained_model', type=str, default="./2/DF21_uq/version_0", help=mes + "(default: '')")
    # infer dataset
    parser.add_argument('--testset', type=str, default="DF21", help=mes + "(default: 'LA21, DF21, ITW')")
    parser.add_argument('--truncate', type=int, default=64600)
    
    
    # ⭐for loss selection
    # (default is CE, WCE, AM, OC, SAM, ASAM,FADEL; other str will be defaultly set to CE)
    parser.add_argument('--loss', type=str, default="WCE")
    # 1 for reduction, 0 for no reduce
    parser.add_argument('--reduce', type=int, default=0)
    parser.add_argument('--loss_lr', type=float, default=0.01)
    ...
    parser.add_argument('--optim', type=str, default="adamw")
    # # learning rate 
    parser.add_argument('--optim_lr', type=float, default=0.00001,help='learning rate (default: 0.00001)')
    # # weight_decay / l2 penalty
    parser.add_argument('--weight_decay', type=float, default=0.0001)
    # for SGD
    parser.add_argument('--momentum', type=float, default=0.9)
